...
This repository is for making adjustments to the PowerShell language grammar syntax scoping file used by VS Code, a JSON formatted file.
...
Included are some scripts for conversion of the JSON file to PList and CSON format, and for interrogating the scopes used within the syntax.
